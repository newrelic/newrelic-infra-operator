...
### 🐞 Bug fixes
- Grant `watch` on `nodes`, `pods`, `services` and `namespaces` in the injected infra-agent ClusterRole so the sidecar's informer works on EKS Fargate, matching the permissions the DaemonSet already has
...
### dependency
- Updated go to v1.26.6 @dbudziwojski [#725](https://github.com/newrelic/newrelic-infra-operator/pull/725)
...
### 🚀 Enhancements
- Add support for Kubernetes 1.35, remove support for 1.30 @jamescripter [#706](https://github.com/newrelic/newrelic-infra-operator/pull/706)
...
### dependency
- Updating Common library to 2.3.1 @philip-r-beckwith (#691)[[https://github.com/newrelic/newrelic-infra-operator/pull/691](https://github.com/newrelic/newrelic-infra-operator/pull/691)\]
...
### 🐞 Bug fixes
- Added comprehensive global value inheritance test suite with 35 test cases validating proper propagation and override precedence of global configuration values @dpacheconr (#613)[[https://github.com/newrelic/newrelic-infra-operator/pull/613](https://github.com/newrelic/newrelic-infra-operator/pull/613)\]
...
### ⛓️ Dependencies
- Updated k8s.io/utils digest to bc988d5
- Upgraded sigs.k8s.io/controller-runtime from 0.21.0 to 0.22.3
